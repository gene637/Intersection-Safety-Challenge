...
kitti_categories = ('VRU_Adult_Using_Motorized_Bicycle', 'Passenger_Vehicle', 'VRU_Child', 'VRU_Adult', 'VRU_Adult_Using_Cane', 
...
def _create_reduced_point_cloud(data_path,
    ...
    for info in mmengine.track_iter_progress(kitti_infos):
        ...
        keep1 = points_v[:,0]>-30 
        points_v = points_v[keep1]
        keep2 = points_v[:,0]<62
        points_v = points_v[keep2]
        keep3 = points_v[:,1]>-50
        points_v = points_v[keep3]
        keep4 = points_v[:,1]<55
        points_v = points_v[keep4]
        if save_path is None:
