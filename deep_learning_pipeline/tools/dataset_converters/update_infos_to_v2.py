...
def update_kitti_infos(pkl_path, out_dir):
    ...
    METAINFO = {
        # 'classes': ('Pedestrian', 'Cyclist', 'Passenger_Vehicle', 'Van', 'Truck',
        #             'Person_sitting', 'Tram', 'Misc'),
        'classes': ('VRU_Adult_Using_Motorized_Bicycle', 'Passenger_Vehicle',
                    'VRU_Child', 'VRU_Adult', 'VRU_Adult_Using_Cane', 
