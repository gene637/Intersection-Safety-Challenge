...
r"""Adapted from `TUMTraf to KITTI converter
...
class TUMTrafI2KITTI(object):
    """TUMTrafI to KITTI converter. There are 2 steps as follows:

    Step 1. TUMTrafI has been saved as kitti format.
