...
class KittiDataset(Det3DDataset):
    ...
    METAINFO = {
        'classes': ('VRU_Adult_Using_Motorized_Bicycle', 'Passenger_Vehicle', 'VRU_Child', 'VRU_Adult', 'VRU_Adult_Using_Cane', 
        ...
        'palette': [(106, 0, 228), (119, 11, 32), (165, 42, 42), (0, 0, 192), (0, 0, 100),
                    (197, 226, 255), (0, 60, 100), (0, 0, 142), (255, 77, 255), (100, 0, 192), (0, 100, 192), (100, 100, 192), (0, 100, 200)]
    ...
    def __init__(self,
                ...
                #  pcd_limit_range: List[float] = [0, -40, -3, 70.4, 40, 0.0],
                 pcd_limit_range: List[float] = [-30, -50, -7, 62, 55, 0],
                 **kwargs) -> None:
