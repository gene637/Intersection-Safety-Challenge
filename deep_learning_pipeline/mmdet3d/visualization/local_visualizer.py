        ...
        if hasattr(self, 'o3d_vis'):
            if hasattr(self, 'view_port'):
                self.view_control.convert_from_pinhole_camera_parameters(
                    self.view_port)
            #     # 读取viewpoint参数
            #     param = o3d.io.read_pinhole_camera_parameters('/home/gene/mmdetection3d/viewpoint_lidar1.json')
            #     # 转换视角
            #     self.view_control.convert_from_pinhole_camera_parameters(param, True)
            # # 读取viewpoint参数
            # param = o3d.io.read_pinhole_camera_parameters('/home/gene/mmdetection3d/viewpoint_lidar1.json')
            # # 转换视角
            # self.view_control.convert_from_pinhole_camera_parameters(param, True)
            ...
            if wait_time != -1:
                ...
                while not self.flag_next and self.o3d_vis.poll_events():
                    ...
                    self.view_port = \
                        self.view_control.convert_to_pinhole_camera_parameters()  # noqa: E501
                    #o3d.io.write_pinhole_camera_parameters('/home/gene/mmdetection3d/viewpoint8.json', self.view_port)
                self.flag_next = False
