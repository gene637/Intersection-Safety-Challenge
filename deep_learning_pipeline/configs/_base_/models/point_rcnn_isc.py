model = dict(
    ...
    rpn_head=dict(
        ...
        bbox_coder=dict(
            ...
            use_mean_size=True,
            mean_size=[[2.1, 1, 1.7], [5.2, 2.8, 1.96], [0.77, 0.58, 0.97], [0.76, 0.7, 1.66], [0.55,0.75,2.04], [1.06, 1.02, 1.29], [1.34, 1.32, 1.88], [0.95, 1.2, 2.18], [0.77, 0.81, 1.64], [1, 1, 1.4], [1.43, 0.79, 1.78]])),
    roi_head=dict(
